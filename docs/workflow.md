...
- **Demand Elegance (Balanced):** For non-trivial changes, pause and ask whether there is a more elegant solution. Do not over-engineer simple or obvious fixes.
- **Autonomous Bug Fixing:** When given a bug report, fix it without asking for unnecessary guidance. Review logs, errors, and failing tests, then resolve them.
