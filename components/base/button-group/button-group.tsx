...
export const styles = sortCx({
  common: {
    root: [
      ...
      // Disabled styles
      'disabled:cursor-not-allowed disabled:bg-primary',
      // Selected styles
  ...
  sizes: {
    xs: {
      root: 'gap-1.5 px-2 py-1 text-xs not-last:pr-[calc(calc(var(--spacing)*2)+1px)] first:rounded-l-lg last:rounded-r-lg data-icon-leading:pl-2 data-icon-only:p-2',
      icon: 'size-4',
    },
    sm: {
