    ...
    case 'right':
      return (
        <div className="flex items-center gap-3">
          ...
          <span
            className={cx(
              'text-secondary shrink-0 text-sm font-medium tabular-nums',
              labelClassName
            )}
          >
            {formattedValue}
    ...
    case 'bottom':
      return (
        <div className="flex flex-col items-end gap-2">
          {baseProgressBar}
          <span className={cx('text-secondary text-sm font-medium tabular-nums', labelClassName)}>
            {formattedValue}
          </span>
        </div>
      );
    case 'top-floating':
      return (
        <div className="relative flex flex-col items-end gap-2">
          ...
          >
            <div
              className={cx('text-secondary text-xs font-semibold tabular-nums', labelClassName)}
            >
              {formattedValue}
            </div>
          </div>
    ...
    case 'bottom-floating':
      return (
        <div className="relative flex flex-col items-end gap-2">
          ...
          >
            <div className={cx('text-secondary text-xs font-semibold', labelClassName)}>
              {formattedValue}
            </div>
          </div>
        </div>
