    ...
    <div className="relative flex w-full flex-1 flex-row flex-wrap items-center justify-start gap-1.5">
      ...
      >
        <AriaInput
          ...
          className="text-md text-primary caret-alpha-black/90 placeholder:text-placeholder w-full flex-[1_0_0] appearance-none bg-transparent text-ellipsis outline-hidden focus:outline-hidden disabled:cursor-not-allowed"
        />
