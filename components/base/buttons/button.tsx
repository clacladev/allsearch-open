...
export const styles = sortCx({
  ...
  sizes: {
    xs: {
      root: [
        'gap-1 rounded-md px-2.5 py-1.5 text-xs font-semibold before:rounded-[5px] data-icon-only:p-1.5 *:data-icon:size-4',
  ...
  colors: {
    ...
    'primary-destructive': {
      root: [
        'bg-error-solid text-white shadow-xs-skeuomorphic ring-1 ring-transparent outline-error ring-inset',
        // Inner border gradient
        'before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0%',
        // Disabled styles
        'disabled:opacity-50 disabled:shadow-xs',
