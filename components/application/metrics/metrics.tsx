  ...
  return (
    <div
      className={cx(
        ...
        type === 'modern' &&
          'bg-primary ring-primary rounded-md py-0.5 pr-2 pl-1.5 shadow-xs ring-1 ring-inset',
        className
      )}
    >
      <Icon
        className={cx(
          'text-fg-success-secondary stroke-[3px]',
  ...
  return (
    ...
    >
      <div className="relative flex flex-col gap-2 px-4 py-5 md:px-5">
        <h3 className="text-tertiary text-sm font-medium">{subtitle}</h3>

        <div className="flex items-end gap-4">
          <p className="text-display-sm text-primary flex-1 font-semibold">{title}</p>
          {!!change && <MetricChangeIndicator type={type} trend={trend} value={change} />}
        </div>
      ...
      {footer && (
        <div className="border-secondary flex items-center justify-end border-t p-4 md:px-5">
          {footer}
        </div>
      )}
    </div>
    ...
    >
      <div className="relative flex flex-col gap-4 px-4 py-5 md:gap-5 md:px-5">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-md text-primary font-semibold">{subtitle}</h3>
        </div>
  ...
  return (
    ...
    >
      <div className="relative flex flex-col gap-4 px-4 py-5 md:gap-5 md:px-5">
        ...
        <div className="flex flex-col gap-2">
          <h3 className="text-tertiary text-sm font-semibold">{subtitle}</h3>
      ...
      {footer && (
        <div className="border-secondary flex items-center justify-end border-t p-3 pr-4 md:p-4 md:pr-5">
          {footer}
        </div>
      )}
    </div>
...
export const MetricsIcon04 = ({
  ...
  return (
    <div
      className={cx(
        'bg-primary ring-secondary min-w-70 rounded-xl shadow-xs ring-1 ring-inset',
        className
      )}
    >
        ...
        <div className="flex items-end justify-between gap-4">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-2">
              ...
              <span className="text-tertiary text-sm font-medium">{changeDescription}</span>
            </div>
          </div>
...
export const MetricsChart02 = ({
  ...
  const id = useId();
  const chartColor =
    changeTrend === 'positive' ? 'text-fg-success-secondary' : 'text-fg-error-secondary';
      ...
      <div className="relative flex flex-col gap-4 px-4 py-5 md:gap-5 md:px-5">
        ...
        <div className="flex items-end justify-between gap-4">
          <div className="flex items-start gap-2">
            <p className="text-display-sm text-primary lg:text-display-md flex-1 font-semibold">
              {title}
            </p>
            <MetricChangeIndicator type="trend" trend={changeTrend} value={change} />
          </div>
...
export const MetricsChart04 = ({
  ...
  return (
    <div
      className={cx(
        'bg-secondary_subtle ring-secondary flex flex-col overflow-hidden rounded-xl shadow-xs ring-1 ring-inset',
        className
      )}
    >
      <div className="mb-0.5 px-4 pt-3 pb-2 md:px-5">
        <h3 className="text-primary text-sm font-semibold">{subtitle}</h3>
      </div>
      <div className="bg-primary ring-secondary relative flex flex-col gap-4 rounded-xl px-4 py-5 shadow-xs ring-1 ring-inset md:gap-5 md:px-5">
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-3">
            <p className="text-display-sm text-primary font-semibold">{title}</p>
            <div className="flex gap-2">
              <MetricChangeIndicator type={type} trend={changeTrend} value={change} />
              {changeDescription && (
                <span className="text-tertiary text-sm font-medium">{changeDescription}</span>
