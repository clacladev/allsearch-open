...
export const NavItemBase = ({
  ...
  const iconElement = Icon && (
    <Icon
      aria-hidden="true"
      className="text-fg-quaternary transition-inherit-all mr-2 size-5 shrink-0"
    />
  );
  ...
  const labelElement = (
    <span
      className={cx(
        'text-secondary transition-inherit-all group-hover:text-secondary_hover flex-1 text-sm font-semibold',
        truncate && 'truncate',
