...
export type DateRangePickerValue = { start: DateValue; end: DateValue };

export type DateRangePickerPresets = Record<string, { label: string; value: DateRangePickerValue }>;
