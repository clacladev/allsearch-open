...
// light/dark/mobile screenshot harness against the legacy pre-migration
// render of the Organization settings tab (screen SCREEN-020), giving the
// shadcn migration's Organization settings pilot a ready-made "before"
// baseline.
